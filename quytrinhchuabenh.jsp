...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="../assets/css/Quytrinh.css">
    <link rel="stylesheet" href="../assets/css/footer.css">
    <title>Quy trình khám chữa bệnh</title>
</head>
<body>
...
<div class="main" style="padding: 50px 0;">
        <div class="row">
            <div class="col-sm-8">
                <a href="">BỆNH NHÂN CẦN BIẾT
                </a>
                <hr>
                <h2>Hướng dẫn khám chữa bệnh</h2>
                <div class="text"> 
                    <p>15/07/2023 16:11</p>
                </div>
                <div class="head">
                    <p>Quy trình khám chữa bệnh tại Bệnh Viện Bạch Mai</p>
                </div>
                <img src="../assets/img/quytrinhkhambenh/anh1.jpg" style="width: 100%;" alt="">
            </div>
            <div class="col-sm-4">
                <div class="top">
                ...
                <img src="../assets/img/quytrinhkhambenh/anhqc1.png" style="width: 100%;" alt="">
                <img src="../assets/img/quytrinhkhambenh/anhqc2.png" style="width: 100%;" alt="">
            </div>
        </div>
    </div>
